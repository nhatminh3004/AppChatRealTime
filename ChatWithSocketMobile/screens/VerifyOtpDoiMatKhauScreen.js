...
export default function VerifyOtpDoiMatKhauScreen({
  route: {
    params: { phoneNumber },
  },
  navigation,
  ...
  const guiMaOtp = () => {
    ...
    phoneProvider
      .verifyPhoneNumber(phoneNumber, recaptchaVerifiy.current)
      .then(setverifycationID);
  };
  const xacThucOtp = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.content}>
        Hãy nhấn vào nút gửi mã Otp ở phía dưới, chúng tôi đã gửi mã gồm 6 số
      ...
      <View style={styles.otpContainer}>
        ...
        <View style={styles.otpBox}>
          <TextInput
            ...
            onChangeText={(text) => {
              setOTP({ ...OTP, 2: text });
              text ? input_3.current.focus() : input_1.current.focus();
            }}
          />
        </View>
        <View style={styles.otpBox}>
          <TextInput
            ...
            onChangeText={(text) => {
              setOTP({ ...OTP, 3: text });
              text ? input_4.current.focus() : input_2.current.focus();
            }}
          />
        </View>
        <View style={styles.otpBox}>
          <TextInput
            ...
            onChangeText={(text) => {
              setOTP({ ...OTP, 4: text });
              text ? input_5.current.focus() : input_3.current.focus();
            }}
          />
        </View>
        <View style={styles.otpBox}>
          <TextInput
            ...
            onChangeText={(text) => {
              setOTP({ ...OTP, 5: text });
              text ? input_6.current.focus() : input_4.current.focus();
            }}
          />
        </View>
        <View style={styles.otpBox}>
          <TextInput
            ...
            onChangeText={(text) => {
              setOTP({ ...OTP, 6: text });
              text ? input_6.current.focus() : input_5.current.focus();
            }}
          />
        </View>
      </View>
